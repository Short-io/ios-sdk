...
public struct ShortIOParameters: Encodable, Sendable {
    ...
    @available(*, deprecated, message: "'domain' is supplied by initialize(apiKey:domain:) and will be removed in a future major release. Set it here only to override that for a single call.")
